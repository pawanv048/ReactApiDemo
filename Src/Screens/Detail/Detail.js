...
export default App = ({navigation, route}) => {
  ...
  const getDataUsingPost = () => {
    ...
    fetch("http://84.16.239.66/api/ReleaseUpdate/PublishRelease?ReleaseId=77763&Status=true&Comment=", requestOptions)
      ...
      <View style={{ flex: 1, padding: 20 }}>
        <View style={styles.releaseContainer}>
          <View >
            ...
            <TouchableOpacity style={styles.accept} onPress={getDataUsingPost}>
              <Text style={{ color: 'white', fontSize: 16 }}>Approve</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.Reject} onPress={() => setShowModal(!showModal)}>
